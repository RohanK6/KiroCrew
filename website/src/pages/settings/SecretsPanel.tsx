                    ...
                    >
                      ...
                      {managedEditName === secret.name ? (
                        ...
                        <div className="flex items-center gap-2 self-end md:self-auto">
                          ...
                          <Btn onClick={() => openAdd(secret.name)} disabled={showAdd || setMutation.isPending || deleteMutation.isPending}>
                            {configured
            ...
            {showAdd && managedEditName === null ? (
              <div className="mt-4 space-y-3 rounded border border-border p-3">
                <div>
                  ...
                  {managedEditName ? (
                    <code className="block rounded border border-border bg-bg-elevated px-3 py-2 text-[13px] text-text-strong">
                      {managedEditName}
                    </code>
                  ) : (
                    <Input
                ...
                <div>
                  ...
                  <Input
                    ...
                    value={newValue}
                    onChange={e => setNewValue(e.target.value)}
                    placeholder={managedEditName ? undefined : i18nT('settings.secrets.value_placeholder')}
                    className="font-mono"
                    aria-label={i18nT('settings.secrets.secret_value_aria')}
                    autoFocus={managedEditName !== null}
                  />
                </div>
